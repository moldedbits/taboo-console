class TabooWordListsController < ApplicationController
  ...
  def create
    ...
    puts "aifsduhfbasduhvbsduvbv " + word_lists.size.to_s + @words_with_error.size.to_s
    if @words_with_error.size == word_lists.size #new
      @all_error_rows = "- All rows in this file contains errors" #new
